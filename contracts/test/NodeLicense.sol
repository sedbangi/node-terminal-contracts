...
contract NodeLicense is ERC721EnumerableUpgradeable, AccessControlUpgradeable {
    ...
    function initialize(address _admin, address payable _fundsReceiver) public initializer {
        __ERC721_init("NodeLicense", "NLN");
    ...
    function tokenURI(uint256 _tokenId) public view override returns (string memory) {
        ...
        string memory svg = string(
            abi.encodePacked(
                "<svg xmlns='http://www.w3.org/2000/svg' width='100' height='100' style='background-color:grey;'><circle r='60' cx='50' cy='50' fill='none' stroke='red' stroke-width='20' transform='scale(0.1) translate(60, 60)'/><text x='5' y='25' font-size='2.8' fill='white' font-family='monospace'>License Id: ",
                _tokenId.toString(),
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "Token #',
                        _tokenId.toString(),
                        '", "description": "Licence Key NFT (ETH)", "image": "data:image/svg+xml;base64,',
                        image,
